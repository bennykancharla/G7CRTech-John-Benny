...
let authorsList=[
  ...
  },
  {
    ...
    "name": "JK Rowling",
    "id": "jk-rowling",
    "photo": "https://cdn.vocabulary.com/units/zqj6yx5p/author.jpg?width=400&v=16df50c7e63",
  ...
  },
  {
    ...
    "id": "keigo-higashino",
    "photo": "https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/authors/1289592746i/117366._UX200_CR0,33,200,200_.jpg",
...
interface AuthorManageProps{
  showAddAuthorScreen : string | null
}


export const AuthorManageScreen = ({ showAddAuthorScreen}: AuthorManageProps) => {
    ...
    const addNewAuthor = (newAuthor:any) => {
      // console.log("Inside add new author")
    ...
    return (
        <div className='row g-0'>
            <div className='col col-5 author-list'>
                <AuthorList authors={authors} onAuthorSelect={(author:any)=>setSelectedAuthor(author)} />
            </div>
