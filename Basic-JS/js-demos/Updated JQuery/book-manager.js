...
class BookManager {
    ...
    getAverageRating(){
        var ratingList = this._books.map(b => b.rating);
        var averageRating = ratingList.onAverage((i,v) => i+v);
        return averageRating;
    }
    getAveragePrice(){
        var priceList = this._books.map(b => b.price);
        var priceRating = priceList.onAverage((i,v) => i+v);
        return priceRating;
    }
